    ...
    >
      <div className="mb-4 rounded-lg border border-blue-200 bg-blue-50 p-3">
        <p className="text-sm text-blue-800">
          <strong>Demo Mode:</strong> This is a demo project, so we're keeping
          it simple! In a real application, you'd typically have proper user
          authentication. Enter a username below or shuffle through random
          suggestions.
        </p>
      </div>
